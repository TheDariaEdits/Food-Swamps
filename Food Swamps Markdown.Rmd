...
I also added the calculated food swamp variables and added them to the data frame. My last data preparation step included removing all Puerto Rico values since there was no data for the variables, but the original source include their FIPS. This created an abundance of Na's. Lastly, I removed any Na's from the Value column as this meant their was no CVD deaths data to analyze and would throw errors in later analysis. 
...
Multivariate model 1 has the highest R squared, significant p, and t values. I will go forward with models 1-3. I am not going forward with models 3-6 because it showed too small of an increase in fit for adding another variable. 
